...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav id="sidebarNav">
            <a href="administrator_assign_subject.php" class="active">Assign subject / teacher / classroom</a>
    ...
    <main class="main">
        ...
        <div class="content-box">
            <p class="description">
                This features allows you to manage the assignment of subjects, teachers, and classrooms.
            </p>
            ...
            <div class="quick-actions">
                <h3>Quick Actions:</h3>
                <ul>
                    <li><a href="administrator_create_schedule.php">Create Schedule</a> to assign new subjects</li>
                    <li><a href="administrator_view_schedule.php">View Schedule</a> to see all the assignments</li>
                    <li><a href="administrator_update_schedule.php">Update Schedule</a> to modify existing assignments</li>
                </ul>
