...
// -------------------------
// GET SELECTED SCHEDULE (WITH JOIN FIX)
// -------------------------
if (isset($_GET['id'])) {
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav id="sidebarNav">
            ...
            <a href="administrator_delete_schedule.php" class="active">Delete Schedule</a>
    ...
    <main class="main">
        ...
        <?php if ($deleted): ?>
            ...
            <div class="success-box">
                ...
                <br><br>
                <a href="administrator_view_schedule.php" class="btn-cancel">Back to List</a>
            </div>
...
<?php if ($selectedSchedule === null): ?>
    ...
    <tr>
        <td colspan="2">No schedule selected</td>
    </tr>
...
<?php else: ?>
    ...
    <tr>
        ...
        <td>
            <?php echo htmlspecialchars($selectedSchedule['course_code'] ?? 'N/A'); ?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <?php echo htmlspecialchars($selectedSchedule['description'] ?? 'N/A'); ?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <?php echo htmlspecialchars($selectedSchedule['instructor_name'] ?? 'N/A'); ?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <?php echo htmlspecialchars($selectedSchedule['room_name'] ?? 'N/A'); ?>
        </td>
    </tr>
    ...
    <td>
        <?php 
            $start = $selectedSchedule['start_time'] 
                ? date("h:i A", strtotime($selectedSchedule['start_time'])) 
                : '';

            $end = $selectedSchedule['end_time'] 
                ? date("h:i A", strtotime($selectedSchedule['end_time'])) 
                : '';

            echo htmlspecialchars(
                ($selectedSchedule['day'] ?? '') . " " . $start . " - " . $end
            );
        ?>
    </td>
</tr>
    ...
    <tr>
        ...
        <td>
            <?php echo htmlspecialchars($selectedSchedule['section']); ?>
        </td>
    </tr>
...
<?php endif; ?>
            ...
            <form method="POST" class="btn-container">
                ...
                <a href="administrator_view_schedule.php" class="btn-cancel">Cancel</a>
            </form>
